...
const vehicleData = [
  { id: 1, vehicle_type_id: 1, category_id: 1, brand_id: 1, max_load_capacity: 5000.00, model: 'Camry' },
  { id: 2, vehicle_type_id: 2, category_id: 2, brand_id: 2, max_load_capacity: 7000.00, model: 'F-150' },
  { id: 3, vehicle_type_id: 1, category_id: 1, brand_id: 3, max_load_capacity: 6000.00, model: 'Malibu' },
  { id: 4, vehicle_type_id: 2, category_id: 2, brand_id: 4, max_load_capacity: 8000.00, model: 'Civic' },
  { id: 5, vehicle_type_id: 1, category_id: 3, brand_id: 5, max_load_capacity: 9000.00, model: 'Jetta' },
  { id: 6, vehicle_type_id: 2, category_id: 3, brand_id: 6, max_load_capacity: 10000.00, model: 'Altima' },
  { id: 7, vehicle_type_id: 1, category_id: 4, brand_id: 7, max_load_capacity: 12000.00, model: 'E-Class' },
  { id: 8, vehicle_type_id: 2, category_id: 4, brand_id: 8, max_load_capacity: 15000.00, model: 'X5' },
  { id: 9, vehicle_type_id: 1, category_id: 5, brand_id: 9, max_load_capacity: 18000.00, model: 'A4' },
  { id: 10, vehicle_type_id: 2, category_id: 5, brand_id: 10, max_load_capacity: 20000.00, model: 'Santa Fe' },
  { id: 11, vehicle_type_id: 1, category_id: 1, brand_id: 1, max_load_capacity: 4800.00, model: 'Corolla' },
  { id: 12, vehicle_type_id: 2, category_id: 2, brand_id: 2, max_load_capacity: 7200.00, model: 'Ranger' },
  { id: 13, vehicle_type_id: 1, category_id: 1, brand_id: 3, max_load_capacity: 5600.00, model: 'Impala' },
  { id: 14, vehicle_type_id: 2, category_id: 2, brand_id: 4, max_load_capacity: 7800.00, model: 'Accord' },
  { id: 15, vehicle_type_id: 1, category_id: 3, brand_id: 5, max_load_capacity: 8500.00, model: 'Passat' },
  { id: 16, vehicle_type_id: 2, category_id: 3, brand_id: 6, max_load_capacity: 9800.00, model: 'Maxima' },
  { id: 17, vehicle_type_id: 1, category_id: 4, brand_id: 7, max_load_capacity: 11200.00, model: 'CLS' },
  { id: 18, vehicle_type_id: 2, category_id: 4, brand_id: 8, max_load_capacity: 14500.00, model: 'X3' },
  { id: 19, vehicle_type_id: 1, category_id: 5, brand_id: 9, max_load_capacity: 17500.00, model: 'A6' },
  { id: 20, vehicle_type_id: 2, category_id: 5, brand_id: 10, max_load_capacity: 19800.00, model: 'Tucson' },
  { id: 21, vehicle_type_id: 3, category_id: 3, brand_id: 5, max_load_capacity: 8500.00, model: 'Passat' },
  { id: 22, vehicle_type_id: 3, category_id: 3, brand_id: 6, max_load_capacity: 9800.00, model: 'Maxima' },
  { id: 23, vehicle_type_id: 3, category_id: 4, brand_id: 7, max_load_capacity: 11200.00, model: 'CLS' },
  { id: 24, vehicle_type_id: 3, category_id: 4, brand_id: 8, max_load_capacity: 14500.00, model: 'X3' },
  { id: 25, vehicle_type_id: 3, category_id: 5, brand_id: 9, max_load_capacity: 17500.00, model: 'A6' },
  { id: 26, vehicle_type_id: 3, category_id: 5, brand_id: 10, max_load_capacity: 19800.00, model: 'Tucson' }
];
